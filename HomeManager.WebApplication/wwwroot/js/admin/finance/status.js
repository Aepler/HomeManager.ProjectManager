...
function List() {
    var table = $("#tblStatusAdmin").DataTable({
        ...
        "order": [[0, "ASC"]],
        "ajax": {
            "url": '/Admin/Finance/GetStatusTableData',
            "type": "POST",
            "datatype": "json"
        },
        "rowId": 'id',
...
function GetStatusEdit(id) {
    $.ajax({
        cache: false,
        type: "GET",
        url: "/Admin/Finance/GetStatus/" + id,
...
function CreateStatusPost(table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/CreateStatus",
...
function EditStatusPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/EditStatus/" + id,
...
function DeleteStatusPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/DeleteStatus/" + id,
