...
function List() {
    var table = $("#tblCategoryAdmin").DataTable({
        ...
        "order": [[0, "ASC"]],
        "ajax": {
            "url": '/Admin/Finance/GetCategoryTableData',
            "type": "POST",
            "datatype": "json"
        },
        "rowId": 'id',
...
function GetCategoryEdit(id) {
    $.ajax({
        cache: false,
        type: "GET",
        url: "/Admin/Finance/GetCategory/" + id,
...
function CreateCategoryPost(table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/CreateCategory/",
...
function EditCategoryPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/EditCategory/" + id,
...
function DeleteCategoryPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Admin/Finance/DeleteCategory/" + id,
