...
function List() {
    var table = $("#tblCategoryCustomize").DataTable({
        ...
        "order": [[0, "ASC"]],
        "ajax": {
            "url": '/Customize/Finance/GetCategoryTableData',
            "type": "POST",
            "datatype": "json"
        },
        "rowId": 'id',
...
function GetCategoryEdit(id) {
    $.ajax({
        cache: false,
        type: "GET",
        url: "/Customize/Finance/GetCategory/" + id,
...
function CreateCategoryPost(table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/CreateCategory/",
...
function EditCategoryPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/EditCategory/" + id,
...
function DeleteCategoryPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/DeleteCategory/" + id,
