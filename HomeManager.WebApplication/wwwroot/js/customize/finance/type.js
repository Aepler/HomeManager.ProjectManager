...
function List() {
    var table = $("#tblTypeCustomize").DataTable({
        ...
        "order": [[0, "ASC"]],
        "ajax": {
            "url": '/Customize/Finance/GetTypeTableData',
            "type": "POST",
            "datatype": "json"
        },
        "rowId": 'id',
...
function GetTypeEdit(id) {
    $.ajax({
        cache: false,
        type: "GET",
        url: "/Customize/Finance/GetType/" + id,
...
function CreateTypePost(table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/CreateType/",
...
function EditTypePost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/EditType/" + id,
...
function DeleteTypePost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/DeleteType/" + id,
