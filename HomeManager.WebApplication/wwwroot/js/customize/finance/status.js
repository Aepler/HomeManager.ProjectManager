...
function List() {
    var table = $("#tblStatusCustomize").DataTable({
        ...
        "order": [[0, "ASC"]],
        "ajax": {
            "url": '/Customize/Finance/GetStatusTableData',
            "type": "POST",
            "datatype": "json"
        },
        "rowId": 'id',
...
function GetStatusEdit(id) {
    $.ajax({
        cache: false,
        type: "GET",
        url: "/Customize/Finance/GetStatus/" + id,
...
function CreateStatusPost(table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/CreateStatus/",
...
function EditStatusPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/EditStatus/" + id,
...
function DeleteStatusPost(id, table) {
    $.ajax({
        cache: false,
        type: "Post",
        url: "/Customize/Finance/DeleteStatus/" + id,
