...
{
    public partial class HomeManagerIdentityTest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount_Extra = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Invoice = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    fk_TypeId = table.Column<int>(type: "int", nullable: false),
                    fk_CategoryId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Types",
                columns: new[] { "Id", "Deleted", "Name", "TaxType" },
                values: new object[,]
                {
                    { 1, false, "Salary", "Net" },
                    { 2, false, "Monthly Expens", "Gross" },
                    { 3, false, "Expenditure", "Gross" },
                    { 4, false, "Earnings", "Gross" },
                    { 5, false, "Start Balance", "None" }
                });
